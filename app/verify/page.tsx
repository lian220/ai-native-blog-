      ...
      <div className="text-center">
        {status === 'loading' && (
          <>
            ...
            <p className="text-neutral-600 dark:text-neutral-400">인증 처리 중...</p>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <h1 className="text-2xl font-semibold mb-2">구독 완료!</h1>
        ...
        {status === 'error' && (
          <>
            <div className="text-5xl mb-4">❌</div>
            <h1 className="text-2xl font-semibold mb-2">인증 실패</h1>
            <p className="text-neutral-600 dark:text-neutral-400 mb-6">{message}</p>
            <Link
              href="/"
              className="px-6 py-2 bg-black dark:bg-white text-white dark:text-black rounded-md font-medium hover:opacity-80 transition-opacity"
